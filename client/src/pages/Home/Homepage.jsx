      ...
      {open && (
        <div className='w-full h-full absolute sm:px-32 top-0 bg-gray-100 flex flex-col justify-center items-center'>
          ...
          <div className='bg-white rounded-2xl p-10 flex flex-col gap-5 justify-center items-center'>
            <button><SiX onClick={toggle} /></button>

            <p className='text-black bg-yellow-200 font-bold p-3 rounded-md'>You have two options</p>
            <div className='flex flex-col sm:flex-row gap-3 text-white'>
              <Link to="/calculate-calories">
                <button className='bg-blue-500 px-4 p-2 flex gap-2 items-center justify-center rounded-lg shadow-lg hover:bg-blue-600'>calculate your calories<MdOutlineStart /> </button>
              </Link>
              <button className='bg-green-500 px-4 p-2 flex gap-2 items-center justify-center rounded-lg shadow-lg hover:bg-green-600'>make your diet plan <MdOutlineStart /></button>
            </div>
